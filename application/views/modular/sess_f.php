    <table>
        <thead></thead>
        <tbody>
            <?=form_open('user/a_login',array('id'=>'ajax_login'));?>
            <tr> <td><label for="l_unm">Nombre de Usuario</label></td>          <td><label for="l_pwd">Contraseña</label></td>                  <td></td> </tr>
            <tr> <td><?=form_input(array('name'=>'l_unm','id'=>'l_unm'));?></td><td><?=form_password(array('name'=>'l_pwd','id'=>'l_pwd'));?></td> <td><?= form_submit(array('value'=>'Entrar'));?></td> </tr>
